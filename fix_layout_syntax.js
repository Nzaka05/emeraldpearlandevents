...
// The exact new, safe button HTML without escaped quotes in EJS blocks.
const newButtonHtml = `<!-- PEARL Floating Button -->
...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    console.log('Fixed the PEARL button syntax error successfully.');
} else {
